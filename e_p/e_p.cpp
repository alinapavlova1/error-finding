...
// Функция разделения строки на слова по разделителю
...
// Функция валидирования количества входных аргументов командной строки
...
// Функция записи текста в выходной файл
...
// Функция валидации количества слов во входном файле
...
// Функция сопоставления количества слов в двух входных файлах
...
// Функция валидации строки на предмет того, что в строке есть символы английского алфавита
...
// Дополнительная функция для "среза" элементов строки с нужного индекса и в нужном количестве
...
// Функция проверки того, что ошибка заключалась в неправильном сокращении глаголов
...
// Функция проверки того, что ошибка заключалась в неправильном употреблении количественных/порядковых числительных
...
// Функция поиска типа ошибки, допущенного в предложении
...
// Функция нахождение того слова, в котором есть ошибка
